...
(function () {
  ...
  /** Garis masa (.paper-timeline) → HTML pratonton PDF — satu sumber benar untuk _bodyHtml & _renderSubChild. */
...
(function () {
  ...
  window.addEventListener('load', function () {
    navigator.serviceWorker.register('/sw.js?v=415').catch(function (error) {
