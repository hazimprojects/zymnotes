...
(function () {
  ...
  function _getPrintCss(mode) {
    ...
    var rules = [
      ...
      '#zym-pr .zp-board-lbl{display:flex;align-items:center;min-height:20px;font-size:8.5px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;margin-bottom:7px;line-height:1.15}',
      ...
      '#zym-pr .zp-acc-ttl{font-size:12.5px;font-weight:700;color:#1e1e3a;line-height:1.25;display:flex;align-items:center}',
      ...
      '#zym-pr .zp-chip{border:1px solid #d8d8ee;background:#f0f0f8;border-radius:6px;padding:4px 9px;font-size:11.5px;color:#2d2d5a;display:inline-flex;align-items:center;justify-content:center;gap:4px;max-width:100%;line-height:1.32;min-height:26px}',
      // Steps (process flow)
      ...
      // Kata kunci — warna teks sahaja (selari dengan nota; tiada blok latar)
      '#zym-pr .zpkw{display:inline;padding:0;margin:0;border-radius:0;font-size:inherit;line-height:inherit;font-weight:700}',
      '#zym-pr .zpkw-tokoh{color:#9f1239;background:none}',
      '#zym-pr .zpkw-masa{color:#1e40af;background:none}',
      '#zym-pr .zpkw-tahun{color:#075985;background:none}',
      '#zym-pr .zpkw-tempat{color:#166534;background:none}',
      '#zym-pr .zpkw-konsep{color:#9a3412;background:none}',
      '#zym-pr .zpkw-kerajaan{color:#6d28d9;background:none}',
      '#zym-pr .zpkw-istilah{color:#0f766e;background:none}',
      '#zym-pr .zpkw-pentadbiran{color:#92400e;background:none}',
      '#zym-pr .zpkw-perjanjian{color:#be185d;background:none}',
      '#zym-pr .zpkw-peristiwa{color:#b45309;background:none}',
      '#zym-pr .zpkw-gerakan{color:#7e22ce;background:none}',
    ...
    if (isEco) {
      rules.push(
        '#zym-pr.zp-mode-eco .zpkw,#zym-pr.zp-mode-eco [class*="zpkw-"]{color:#1e293b!important;font-weight:700}',
...
(function () {
  ...
  window.addEventListener('load', function () {
    navigator.serviceWorker.register('/sw.js?v=410').catch(function (error) {
