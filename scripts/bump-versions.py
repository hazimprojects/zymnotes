...
RULES: list[tuple[str, list[str]]] = [
    ...
    ("assets/css/openmoji.css",          ["css.openmoji",     "style_css", "sw_cache"]),
    ("assets/css/fluent-shell-emoji.css",["css.fluent_shell", "style_css", "sw_cache"]),
    ("assets/css/bab-hub-fluent-3d.css", ["css.bab_hub",      "style_css", "sw_cache"]),
    ("assets/css/shell-openmoji.css",    ["css.shell_openmoji","style_css","sw_cache"]),
